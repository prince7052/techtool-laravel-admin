...
<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">Do Mail</h1>
    ...
    <div class="card shadow mb-4">
        ...
        <form method="POST" action="{{url('media/store')}}">
            @csrf
            <div class="card-body">
            ...
            <div class="card-footer">
                ...
                <a class="btn btn-primary float-right mr-3 mb-3" href="{{ route('media.mail') }}">Cancel</a>
            </div>
        </form>
    </div>
